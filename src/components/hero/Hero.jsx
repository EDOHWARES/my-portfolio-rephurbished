    ...
    >
      <div className="w-full md:w-1/2">
        <h2 className="text-[2.8rem] md:text-[3.8rem] leading-[3.5rem] md:leading-[5rem] font-[600] mb-[1rem] text-center md:text-start">
          Building High Performing Web Apps for Businesses.
        </h2>
        <p className="w-full text-center md:text-start md:w-[80%] text-[0.8rem] md:text-[1rem] font-[400] leading-[1.3rem] md:leading-[2rem]">
          ...
          that thrives | Transformed Ideas into Seamless and Visually Stunning
          Web Solutions | and contributed to open source projects
        </p>
        <a
          href="https://drive.google.com/file/d/1oIfHhzwzYqAYh9Zz-ScaXW3X0gJj3Am8/view?usp=sharing"
          target="_blank"
      ...
      <div className="relative w-full md:w-auto flex flex-col items-center justify-center">
        <div className="mb-[1rem]">
          <img
            className="w-[25rem] rounded-[2rem] cursor-pointer hover:-translate-y-2 duration-500 filter grayscale"
            src={profile3}
            alt="my photo"
          />
        </div>
