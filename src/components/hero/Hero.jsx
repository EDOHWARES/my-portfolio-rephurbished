    ...
    >
      <div className="w-full md:w-1/2">
        ...
        <p className="w-full text-center md:text-start md:w-[80%] text-[0.8rem] md:text-[1rem] font-[400] leading-[1.3rem] md:leading-[2rem]">
          I develop high-performance dashboards, fintech platforms, and
          blockchain-integrated applications using modern technologies.
          Experienced in building multi-user systems, data-driven interfaces,
          and contributing to production-grade open source projects.
        </p>
        <a
          href="https://drive.google.com/file/d/1HRD6SSg5qsPON-FuaWdj-tVFhGlaUqev/view?usp=sharing"
          target="_blank"
      ...
      <div className="relative w-full md:w-auto flex flex-col items-center justify-center">
        <div className="mb-[1rem]">
          <img
            className="w-[25rem] rounded-[2rem] cursor-pointer hover:-translate-y-2 duration-500 floating-img"
            src={me}
            alt="high-performing web solutions illustration"
          />
        </div>
